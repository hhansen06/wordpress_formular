                    ...
                    <?php foreach ($form['fields'] as $index => $field): ?>
                        <div class="form-field-item" data-field-index="<?php echo $index; ?>">
                            <div class="form-field-header">
                                ...
                                <strong class="field-label-preview"><?php echo esc_html($field['label']); ?></strong>
                            ...
                            <div class="form-field-settings" style="display: none;">
                                <table class="form-table">
                                    ...
                                    <tr class="field-required-row" style="display: <?php echo $field['type'] !== 'heading' ? 'table-row' : 'none'; ?>;">
        ...
        <div class="form-field-settings">
            <table class="form-table">
                ...
                <tr>
                    <th><label>Label</label></th>
                    <td>
                        <input type="text" class="field-label regular-text" name="fields[{{index}}][label]" required>
                    </td>
                </tr>
                <tr>
                    <th><label>Platzhalter</label></th>
